...
public class GLView extends GLSurfaceView
{
    ...
    public void start() {
        synchronized (damalsAR) {
            damalsAR.startTracker();
        }
    }

    public void stop() {
        synchronized (damalsAR) {
            damalsAR.stopTracker();
        }
    }
